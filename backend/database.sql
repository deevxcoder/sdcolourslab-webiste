-- SD Colours Photobook Lab — Database Schema & Data
-- Optimized for MySQL / MariaDB (Laragon Local)
...
(37, 'Prowood Combo Photo Pad – Wooden Rewood 3 IN 1', 'combo', 'Wooden Rewood (3 IN 1) – Leather combined wooden cover with design acrylic window, Cover Photo Pad, Briefcase & Leather Bag', 3800.00, NULL, '["12x24", "12x30", "12x36", "24x15", "18x24"]', '["Leather & Wooden Combined Cover", "Design Acrylic Window", "Cover Photo Pad", "Briefcase", "Leather Bag"]', NULL, '/images/combos/prowood-rewood-3in1.jpg', 1, 14, '2026-04-15 11:11:28'),
